...
// 	protoc        v3.14.0
// source: tasks_grpc/internal/proto-files/messages/tasks_grpc.proto
...
func (x *Task) Reset() {
	*x = Task{}
	if protoimpl.UnsafeEnabled {
		mi := &file_tasks_internal_proto_files_messages_tasks_proto_msgTypes[0]
...
func (*Task) Descriptor() ([]byte, []int) {
	return file_tasks_internal_proto_files_messages_tasks_proto_rawDescGZIP(), []int{0}
}
...
var file_tasks_internal_proto_files_messages_tasks_proto_rawDesc = []byte{
	0x0a, 0x2f, 0x74, 0x61, 0x73, 0x6b, 0x73, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c,
	0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2d, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x2f, 0x6d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x73, 0x2f, 0x74, 0x61, 0x73, 0x6b, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74,
...
var (
	file_tasks_internal_proto_files_messages_tasks_proto_rawDescOnce sync.Once
	file_tasks_internal_proto_files_messages_tasks_proto_rawDescData = file_tasks_internal_proto_files_messages_tasks_proto_rawDesc
)

func file_tasks_internal_proto_files_messages_tasks_proto_rawDescGZIP() []byte {
	file_tasks_internal_proto_files_messages_tasks_proto_rawDescOnce.Do(func() {
		file_tasks_internal_proto_files_messages_tasks_proto_rawDescData = protoimpl.X.CompressGZIP(file_tasks_internal_proto_files_messages_tasks_proto_rawDescData)
	})
...
func init() { file_tasks_internal_proto_files_messages_tasks_proto_init() }
func file_tasks_internal_proto_files_messages_tasks_proto_init() {
	if File_tasks_internal_proto_files_messages_tasks_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_tasks_internal_proto_files_messages_tasks_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Task); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_tasks_internal_proto_files_messages_tasks_proto_goTypes,
		DependencyIndexes: file_tasks_internal_proto_files_messages_tasks_proto_depIdxs,
		MessageInfos:      file_tasks_internal_proto_files_messages_tasks_proto_msgTypes,
	}.Build()
	File_tasks_internal_proto_files_messages_tasks_proto = out.File
	file_tasks_internal_proto_files_messages_tasks_proto_rawDesc = nil
	file_tasks_internal_proto_files_messages_tasks_proto_goTypes = nil
	file_tasks_internal_proto_files_messages_tasks_proto_depIdxs = nil
}
