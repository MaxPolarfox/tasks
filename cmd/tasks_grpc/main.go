...
import (
	...
	"github.com/MaxPolarfox/tasks/pkg/tasks_grpc"
	"github.com/MaxPolarfox/tasks/pkg/types"
)

const ServiceName = "tasks_grpc"
...
func main() {
	...
	taskServiceImpl := tasks_grpc.NewService(options, tasksCollection)
	...
	log.Printf("Listening %s at the port: %d", options.ServiceName, options.Port)
